...
internal static class UserErrorMessages
{
    ...
    public const string MissionDeleteForbidden = "Você não tem permissão para excluir metas nesta organização.";
    ...
    public const string EmployeeCreateForbidden = "Apenas um líder da organização pode criar funcionários.";
    public const string EmployeeUpdateForbidden = "Apenas um líder da organização pode editar funcionários.";
    public const string EmployeeDeleteForbidden = "Apenas um líder da organização pode excluir funcionários.";
    public const string EmployeeAssignTeamsForbidden = "Apenas um líder da organização pode atribuir equipes.";
