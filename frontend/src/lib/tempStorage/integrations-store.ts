...
const SEED_INTEGRATIONS: IntegrationRecord[] = [
  {
    ...
    name: "Slack",
    description:
      "Envie nudges, feedbacks, check-ins e reconhecimentos diretamente nos canais do Slack. Comandos como /bud feedback e /bud okr permitem acoes rapidas sem sair do Slack.",
  ...
  },
  {
    ...
    description:
      "Integre notificacoes, lembretes e comandos rapidos com o Microsoft Teams. Bot nativo para acoes diretas no chat.",
    category: "communication",
  ...
  },
  {
    ...
    description:
      "Envie lembretes e nudges via WhatsApp para gestores. Ideal para equipes que priorizam mobile.",
    category: "communication",
    iconId: "WhatsappLogo",
  ...
  },
  {
    ...
    name: "E-mail (SMTP)",
    description:
      "Configure o servidor de e-mail para notificacoes personalizadas, digests semanais e resumos para executivos.",
    category: "communication",
    iconId: "Envelope",
  ...
  },
  {
    ...
    description:
      "Detecte automaticamente 1:1s agendadas e envie briefings 30 minutos antes da reuniao com contexto completo do liderado.",
    category: "calendar",
  ...
  },
  {
    ...
    description:
      "Sincronize agendas do Outlook para briefings automaticos de 1:1 e deteccao de reunioes recorrentes.",
    category: "calendar",
  ...
  },
  {
    ...
    name: "Gupy",
    description:
      "Importe dados de colaboradores e estrutura organizacional diretamente do Gupy para configuracao rapida.",
    category: "hris",
    iconId: "Database",
  ...
  },
  {
    ...
    description:
      "Conecte com TOTVS RM ou Protheus para sincronizar dados de colaboradores, cargos e departamentos.",
    category: "hris",
    iconId: "Database",
  ...
  },
  {
    ...
    description:
      "Sincronize dados de colaboradores com o SAP SuccessFactors. Ideal para empresas enterprise.",
    category: "hris",
    iconId: "Database",
    iconBg: "var(--color-neutral-100)",
    iconColor: "var(--color-neutral-700)",
  ...
  },
  {
    ...
    name: "Google Sheets",
    description:
      "Importe e exporte dados de performance, OKRs e relatorios para planilhas do Google Sheets.",
    category: "hris",
    iconId: "GoogleLogo",
    iconBg: "var(--color-green-100)",
    iconColor: "var(--color-green-700)",
  ...
  },
  {
    ...
    name: "Importacao CSV",
    description:
      "Importe dados de colaboradores via planilha CSV. Baixe o template, preencha e faca o upload para configuracao rapida.",
    category: "hris",
    iconId: "Upload",
    iconBg: "var(--color-caramel-100)",
    iconColor: "var(--color-caramel-700)",
  ...
  },
  {
    ...
    name: "Jira",
    description:
      "Atualize o progresso de OKRs automaticamente quando tarefas sao concluidas no Jira. Correlacione delivery com execucao estrategica.",
    category: "pm",
    iconId: "GitBranch",
    iconBg: "var(--color-neutral-100)",
    iconColor: "var(--color-neutral-700)",
  ...
  },
  {
    ...
    name: "Asana",
    description:
      "Conecte projetos do Asana para acompanhar progresso de OKRs com base na conclusao de tarefas.",
    category: "pm",
    iconId: "GitBranch",
    iconBg: "var(--color-orange-100)",
    iconColor: "var(--color-orange-700)",
  ...
  },
  {
    ...
    name: "Power BI",
    description:
      "Conecte dashboards do Power BI com dados de performance, engajamento e progresso de OKRs da plataforma.",
    category: "pm",
    iconId: "ChartBar",
    iconBg: "var(--color-yellow-100)",
    iconColor: "var(--color-yellow-700)",
  ...
  },
  {
    ...
    name: "Google SSO",
    description:
      "Login unico com contas Google corporativas. Simplifique o acesso para toda a organizacao com um clique.",
    category: "auth",
    iconId: "GoogleLogo",
    iconBg: "var(--color-green-100)",
    iconColor: "var(--color-green-700)",
  ...
  },
  {
    ...
    description:
      "Login unico com contas Microsoft corporativas e Azure Active Directory. Suporte a SAML 2.0.",
    category: "auth",
    iconId: "ShieldCheck",
    iconBg: "var(--color-neutral-100)",
    iconColor: "var(--color-neutral-700)",
  ...
  },
  {
    ...
    description:
      "Configure qualquer provedor de identidade compativel com SAML 2.0 para login unico corporativo.",
    category: "auth",
    iconId: "ShieldCheck",
    iconBg: "var(--color-wine-100)",
    iconColor: "var(--color-wine-700)",
  ...
  },
  {
    ...
    name: "REST API",
    description:
      "Acesse a API da plataforma para integracoes customizadas. Documentacao completa com exemplos e SDKs.",
    category: "api",
    iconId: "Key",
    iconBg: "var(--color-orange-100)",
    iconColor: "var(--color-orange-700)",
  ...
  },
  {
    ...
    name: "Webhooks",
    description:
      "Receba notificacoes em tempo real quando eventos ocorrerem na plataforma. Configure endpoints customizados.",
    category: "api",
    iconId: "WebhooksLogo",
    iconBg: "var(--color-caramel-100)",
    iconColor: "var(--color-caramel-700)",
...
function mergeWithSeed(
  rawIntegrations: IntegrationRecord[],
): IntegrationRecord[] {
...
function migrateSnapshot(
  raw: Partial<IntegrationsStoreSnapshot> | null,
): IntegrationsStoreSnapshot {
...
export function loadIntegrationsSnapshot(
  ...
  try {
    ...
    console.warn(
      "[integrations-store] Failed to parse stored data, using seed",
    );
    return getSeedSnapshot();
  }
}
...
export function resetIntegrationsSnapshot(
  orgId = DEFAULT_ORG_ID,
): IntegrationsStoreSnapshot {
  const seed = getSeedSnapshot();
