...
describe("getKrOwnerIds", () => {
  it("retorna IDs dos owners de Indicators", () => {
  ...
  it("ignora Indicators sem owner", () => {
    const mission = makeMission({
      indicators: [{ id: "indicator1", owner: null } as any],
    });
    const result = getKrOwnerIds([mission]);
      ...
      indicators: [
        {
          id: "indicator1",
          progress: 40,
          owner: { id: "u1", firstName: "A", lastName: "B", initials: null },
        } as any,
        {
          id: "indicator2",
          progress: 60,
...
describe("daysSinceUserCheckin", () => {
  it("retorna 0 para check-in hoje", () => {
    const history = { "indicator-1": [makeCheckIn("u1", 0)] };
  ...
  it("ignora check-ins de outros usuários", () => {
    const history = { "indicator-1": [makeCheckIn("u2", 1)] };
...
describe("calculateMissionsEngagement", () => {
  ...
  it("calcula % de Indicators com check-ins", () => {
    const mission = makeMission({
      indicators: [{ id: "indicator1" } as any, { id: "indicator2" } as any],
    });
    const history = { indicator1: [makeCheckIn("u1", 1)] }; // 1 de 2 Indicators tem check-in
    ...
    const history = {
      "indicator-1": [
        // 5 check-ins nas últimas 2 semanas
        {
          id: "c1",
          authorId: "u1",
          createdAt: toIsoDateTime(addDays(now, -3)),
          indicatorId: "indicator-1",
          value: "1",
          previousValue: null,
          confidence: null,
        ...
        },
        {
          id: "c2",
          authorId: "u1",
          createdAt: toIsoDateTime(addDays(now, -5)),
          indicatorId: "indicator-1",
          value: "1",
          previousValue: null,
          confidence: null,
        ...
        },
        {
          id: "c3",
          authorId: "u1",
          createdAt: toIsoDateTime(addDays(now, -7)),
          indicatorId: "indicator-1",
          value: "1",
          previousValue: null,
          confidence: null,
        ...
        // 1 check-in entre 2-4 semanas
        {
          id: "c4",
          authorId: "u1",
          createdAt: toIsoDateTime(addDays(now, -25)),
          indicatorId: "indicator-1",
          value: "1",
          previousValue: null,
          confidence: null,
    ...
    const history = {
      "indicator-1": [
        ...
        },
        {
          id: "c2",
          authorId: "u1",
          createdAt: toIsoDateTime(addDays(now, -6)),
          indicatorId: "indicator-1",
          value: "1",
          previousValue: null,
          confidence: null,
