...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    name: "Master",
    description:
      "Para empresas que querem acelerar resultados com apoio especializado e contínuo",
    popular: true,
    features: [
      "Tudo do Pro",
      "Usuários ilimitados",
  ...
  },
  {
    ...
    name: "Enterprise",
    description:
      "Para grandes organizações com necessidades de integração e gerenciamento específicas",
    features: [
      "Tudo do Master",
