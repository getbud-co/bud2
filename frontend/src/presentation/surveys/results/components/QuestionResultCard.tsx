  ...
  return (
    <div className={styles.chartArea}>
      <span className={styles.avgBadge}>
        Média: <strong>{data.average}</strong>
      </span>
      ...
      <div className={styles.npsHeader}>
        ...
        <div className={styles.npsLegend}>
          ...
          <span className={styles.legendItem}>
            <span
              className={styles.legendDot}
              style={{ backgroundColor: "var(--color-warning-400)" }}
            />
          ...
          <span className={styles.legendItem}>
            <span
              className={styles.legendDot}
              style={{ backgroundColor: "var(--color-error-400)" }}
            />
      ...
      <ResponsiveContainer width="100%" height={180}>
        ...
        >
          ...
          <Tooltip
            content={
              <ChartTooltipContent
                valueFormatter={(v: number | string) => `${v} respostas`}
              />
            }
            animationDuration={150}
            animationEasing="ease-out"
    ...
    <div className={styles.yesNoArea}>
      <div className={styles.yesNoItem}>
        ...
        <div className={styles.yesNoDetail}>
          ...
          <span className={styles.yesNoSub}>
            {data.yes} respostas ({data.yesPercent}%)
          </span>
        </div>
      </div>
      <div className={styles.yesNoItem}>
        ...
        <div className={styles.yesNoDetail}>
          ...
          <span className={styles.yesNoSub}>
            {data.no} respostas ({data.noPercent}%)
          </span>
        </div>
      </div>
    </div>
                  ...
                  <TableCell>
                    {hasNumeric && r.numericValue != null ? (
                      <span
                        ...
                        style={{
                          color: getScoreColor(questionType, r.numericValue),
                        }}
                      >
                        {r.numericValue}
                      </span>
...
export function QuestionResultCard({ result, index }: QuestionResultCardProps) {
  const typeLabel =
    QUESTION_TYPE_LABELS[
      result.questionType as keyof typeof QUESTION_TYPE_LABELS
    ] ?? result.questionType;
      ...
      <CardBody>
        <div className={styles.cardHeader}>
          ...
          <div className={styles.headerRight}>
            ...
            <Badge color="neutral" size="sm">
              {result.responseCount} respostas
            </Badge>
            <Button
              variant="secondary"
              size="sm"
