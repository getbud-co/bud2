...
import { Alert, Button } from "@mdonangelo/bud-ds";
    ...
    return (
      <div className={styles.errorContainer}>
        <Alert variant="error" title="Pesquisa não encontrada">
          ...
          {surveyId ? ` (ID: ${surveyId})` : ""}. Verifique o link e tente
          novamente.
        </Alert>
      ...
      <div className={styles.thankYouContainer}>
        <div className={styles.thankYouCard}>
          ...
          <p className={styles.thankYouText}>
            Sua resposta à pesquisa <strong>{surveyData.name}</strong> foi
            enviada com sucesso.
          </p>
          {surveyData.isAnonymous && (
            <p className={styles.thankYouAnonymous}>
              Esta pesquisa é anônima — suas respostas não serão associadas à
              sua identidade.
            </p>
          )}
