...
const CYCLE_PHASES_ORDER: CyclePhase[] = [
  "self_evaluation",
  "peer_evaluation",
  "manager_evaluation",
  "calibration",
  ...
  return (
    <div className={styles.stepContent}>
      ...
      {isCiclo && (
        <section className={styles.formSection}>
          ...
          <div className={styles.cycleTimeline}>
            {CYCLE_PHASES_ORDER.map((phase, index) => {
              const phaseData = state.cyclePhases.find(
                (cp) => cp.phase === phase,
              );
              return (
                <div key={phase} className={styles.timelineItem}>
                  <div className={styles.timelineIndicator}>
                    ...
                    {index < CYCLE_PHASES_ORDER.length - 1 && (
                        ...
                        <div className={styles.phaseDates}>
                          <div className={styles.formField}>
                            <DatePicker
                              ...
                              mode="single"
                              size="sm"
                              value={isoToCalendarDate(
                                phaseData?.startDate ?? null,
                              )}
                              onChange={(cd: CalendarDate | null) => {
      ...
      <section className={styles.formSection}>
        ...
        <p className={styles.sectionDescription}>
          Defina se {isCiclo ? "o ciclo" : "a pesquisa"} será aplicado uma única
          vez ou de forma recorrente
        </p>
      ...
      <section className={styles.formSection}>
        ...
        {state.isAnonymous && (
          <Alert variant="info" title="LGPD">
            Para pesquisas anônimas, grupos com menos de{" "}
            {state.lgpdMinGroupSize} pessoas terão resultados agregados para
            proteger a identidade dos respondentes.
          </Alert>
        )}
      </section>
      ...
      >
        ...
        <p className={styles.sectionDescription}>
          Personalize as mensagens enviadas para cada público. Use {"{nome}"}{" "}
          para incluir o nome {isCiclo ? "do ciclo" : "da pesquisa"}.
        </p>
