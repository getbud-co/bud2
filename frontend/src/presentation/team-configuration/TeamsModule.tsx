...
import type { PopoverItem, AvatarGroupItem } from "@mdonangelo/bud-ds";
import {
  MagnifyingGlass,
  Plus,
  PencilSimple,
          ...
          <>
            ...
            <ModalBody>
              <p className={styles.confirmText}>
                ...
                <strong>{deleteTeam.name}</strong>? Esta ação removerá o time de
                todos os colaboradores associados e não pode ser desfeita.
              </p>
            </ModalBody>
            <ModalFooter>
              <Button
