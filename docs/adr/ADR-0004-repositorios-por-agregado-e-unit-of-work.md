...
- Publicar contratos de repositório em `src/Server/Bud.Application/<Feature>/` (ex: `IGoalRepository` em `Bud.Application.Goals`), pois são os casos de uso quem definem o que precisam da persistência.
