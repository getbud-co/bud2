...
using Xunit;
using TeamsPage = Bud.BlazorWasm.Features.People.Teams.Pages.Teams;

namespace Bud.BlazorWasm.Tests.Features.People.Teams;
...
public sealed class TeamsPageTests : TestContext
{
    ...
    private IRenderedComponent<TeamsPage> RenderTeamsPage()
    {
        ...
        return RenderComponent<TeamsPage>();
    }
