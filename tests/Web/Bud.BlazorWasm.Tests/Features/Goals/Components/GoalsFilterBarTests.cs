...
public sealed class GoalsFilterBarTests : TestContext
{
    ...
    public void Render_ShouldShowMainFilterChips()
    {
        ...
        cut.Markup.Should().Contain("Minhas metas");
    ...
    public void SelectScope_All_ShouldInvokeOnSetFilterWithAll()
    {
        ...
        var scopeChip = chips.First(c => c.TextContent.Contains("metas", StringComparison.OrdinalIgnoreCase));
        scopeChip.Click();

        var allOption = cut.FindAll("button.filter-dropdown-option")
            .First(c => c.TextContent.Contains("Todas as metas", StringComparison.OrdinalIgnoreCase));
        allOption.Click();
    ...
    public void SelectScope_MyTeam_ShouldInvokeOnSetFilterWithMyTeam()
    {
        ...
        var teamOption = cut.FindAll("button.filter-dropdown-option")
            .First(c => c.TextContent.Contains("Metas do time", StringComparison.OrdinalIgnoreCase));
        teamOption.Click();
